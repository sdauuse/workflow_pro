-- Migration script to add estimation field to existing projects table
-- Execute this if you have an existing database without the estimation field

-- Add estimation column to projects table
ALTER TABLE projects 
ADD COLUMN estimation DECIMAL(8,2) DEFAULT NULL COMMENT 'Project estimation in headcount/month';
